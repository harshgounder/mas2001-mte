...
5. Repair PR 14 before merge with item-level scope. The corrected split is 62 in-scope,
   7 boundary, and 50 out-of-scope. Assignment 3 is mixed: 7 items fit lectures 19 to 21,
   7 confidence-interval construction items sit on the boundary, and 11 use MLE, method
   of moments, Bayesian estimation, or other post-MTE material. Its 17 layout-split
   summaries have manual overrides.
