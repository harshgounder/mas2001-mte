...
## Pending enumeration (text already extracted, block pass queued)

| corpus | pages | estimate | note |
|---|---|---:|---|
| S&P L1-7 deck | 109 | ~11 to 13 | 13 marker hits, 2 duplicates; includes Devore problems |
| S&P L8-9 deck | 38 | ~2 to 4 | sparse; 2 problems visible in surface pass |
| S&P L12-13 deck | 29 | ~6 to 8 | pens problem, irregular die, Poisson examples 1 to 3 |
| S&P L14-15 deck | 45 | ~7 to 9 | textbook illustrations (uniform, normal, exponential) |
...
page images. Estimated pending total: 27 to 33 blocks in the four lecture decks plus about
65 in the bundle (#3 to #5, duplicates of the 2024-25 sets with minor variations).
...
distribution sets #1 and #2, 35 blocks, plus estimation-property parts of #3)
= roughly 220 to 230 blocks, exact after the ledger pass.
