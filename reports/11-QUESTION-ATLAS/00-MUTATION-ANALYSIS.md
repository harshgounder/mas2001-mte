...
```
  ...
  6  past MTE papers: ARRIVED 15 Sep (both years + both solution schemes + 4 ETE +
     1 summer + 2 re-sess papers). The Drive sweep item is moot for MTE purposes; the papers
